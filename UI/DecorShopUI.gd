extends CanvasLayer
#
#var draftable_decor : Array
#var target_decor_path : String
#
#func initialize():
	#await %Timeline.update_timeline()
	#%DecorShopTipBox/TurnLabel.text = "DECOR SHOP"
	#%DecorShopTipBox/Tip.text = "Buy a decor. The other will go to your opponent."
